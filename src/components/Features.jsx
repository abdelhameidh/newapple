...
function Features() {
    ...
    useGSAP(()=>{
        ...
        animateWithGsap(
            ".g_grow",{scale: 1, opacity: 1, ease: 'power1.inOut'},
        {scrub:5.5});
  ...
  return (
    ...
    bg-zinc re4lative overflow-hidden'>
            ...
            <div className='mb-12 w-full'>
                ...
                overflow-hidden'>
                    <div className='mt-32 mb-24 pl-24'>
                        ...
                        lg:text-7xl font-semibold'> iphone.
                        </h2>
                        <h2 className='text-5xl lg:text-7xl
                        fint-semibold'>Forged in titanium.
                        </h2>
                        <div className='flex-center flex-col sm:px-10'>
                            ...
                            flex item-center'>
                                ...
                                object-center' preload= "non" muted
                                autoPlay ref={videoRef}> 
                                    <source src={exploreVideo} type=
                                    'video/mp4'/>
                                </video>
                            </div>
                            ...
                            relative'>
                                <div className='feature-video-container'>
                                    ...
                                    flex-1 h-[50vh]'>
                                        <img src={explore1Img} 
                                        alt="taitanium" className=
                                        'feature-video g_grow'/>
                                    </div>
                                    <div className='overflow-hidden
                                    flex-1 h-[50vh]'>
                                        <img src={explore2Img} 
                                        alt="taitanium 2" className=
                                        'feature-video g_grow'/>
                                    </div>
                                </div>
